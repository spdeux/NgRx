...
export class ProductService {
  ...
  // private products: Product[];  //remove because of the effect
  ...
  //step1: by using action & selector, we don't need any more to using behaviourSubject to broad cast current product.
  ...
  //step2:by using action & selector, we don't need any more to using behaviourSubject to broad cast current product.
